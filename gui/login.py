...
def register():
    ...
    btn_enviar = ctk.CTkButton(register_w, text="Registrar", command=cargar_datos, fg_color=GOLD, text_color=DARK_BURGUNDY, hover_color=CREAM, width=200, height=40)
...
# Register button
btn_register = ctk.CTkButton(app_login, text="Registrar", command=register, fg_color=LIGHT_BURGUNDY, text_color=GOLD, hover_color=CREAM, width=200, height=40)
